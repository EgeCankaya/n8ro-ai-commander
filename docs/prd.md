...
**Date:** 2026-07-31 (revised 2026-08-07)
**Status:** Draft v1.8.32
**Revision history:**
...
| **C8** | A `maxTokens` ceiling sized from one 48-order run is sized against noise | Only binds if a non-Haiku model is actually adopted. No value chosen in the meantime |
| **C5** | The memorised-coordinate result is a bounded negative at n = 11 | Only if order quality is measured at scale. **The Stage-B conclusion does not depend on it** |
| **C6** | **OQ-3** remains open — is `n8ro-llm` ever installed | Someone else's roadmap. v1.1 planning, unchanged |
