...
| # | Item | Blocked on |
|---|---|---|
| **C11** | **H1 — the load-bearing hypothesis — has no verdict, and the review it needs has never had an owner** *(new, v1.8.17)* | An owner judgement. **Costs nothing, needs no grant** — the paired logs are retained on both backends |
